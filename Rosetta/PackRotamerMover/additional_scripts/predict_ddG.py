...
def mutate_residue( pose, mutant_position, mutant_aa, pack_radius, pack_scorefxn):
    ...
    #packer = PackRotamersMover( scorefxn=pack_scorefxn, nloop=num, task_operations=task )
    packer = PackRotamersMover(pack_scorefxn, task)
    packer.apply( test_pose )
    #scorefxn: pyrosetta.rosetta.core.scoring.ScoreFunction, task: pyrosetta.rosetta.core.pack.task.PackerTask, nloop: int
    return test_pose
