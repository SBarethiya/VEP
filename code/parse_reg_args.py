...
def get_parser():
    ...
    parser.add_argument("--train_data_tsv",
                    help="Path to the TSV file containing training data.",
                    type=str,
                    default="")

    parser.add_argument("--test_data_tsv",
                         help="Path to the TSV file containing testing data.",
                         type=str,
                         default="")
    ...
    parser.add_argument("--rmsf_file",
                        help="if the dataset_name is not given, then this argument is required. the path to the tsv"
                             " dataset file containing the wt rmsf",
                        type=str,
                        default="")
